    ...
    return (
      ...
      <div class="bg-white mb-5 w-72 m-auto border-1 border-dashed border-gray-900 shadow-2xl rounded-lg overflow-hidden md:w-80 md:mb-4" key={cat.id}>
        ...
        <div class="p-4">
          ...
          <div class="mt-8 mb-3">
            <a href={`/gatos/${cat.id}`} class="px-4 py-2 bg-teal-500 shadow-lg border rounded-lg text-white uppercase font-semibold tracking-wider focus:outline-none focus:shadow-outline hover:bg-teal-400 active:bg-teal-400">Adoptar</a>
          </div>
        </div>
