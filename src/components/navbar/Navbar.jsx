...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <NavLink to="/login"><button type="button" class="text-gray bg-teal-900 hover:bg-teal-500 focus:ring-4 focus:outline-none focus:ring-teal-00 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-teal-400 dark:hover:bg-white-200 dark:focus:ring-teal-400">iniciar sesion</button> </NavLink>
